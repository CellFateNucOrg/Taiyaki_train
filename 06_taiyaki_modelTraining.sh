...
echo "Training mod_factor (relative importance of modifications in training criterion ): " ${modFactorVar}
...
if [ ${mappedReadsAvailable} == 0 ]; then echo "File containing mapped reads not available"; exit; fi
...
### It will be necessary to slightly adjust the code below ! (see https://github.com/nanoporetech/taiyaki/blob/master/docs/modbase.rst) ###
